...
export const alt = "Solitaire Friends";

export default async function OpenGraphImage() {
  const product = getProduct("solitaire-friends", "en");
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ color: "#5c5c5c", fontSize: 24 }}>kadirkasim.com/games/solitaire-friends</div>
      </div>
    ),
    { ...size },
  );
